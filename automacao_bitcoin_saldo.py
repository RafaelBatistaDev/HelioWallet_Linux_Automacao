...
# ─────────────────────────────────────────────
def executar_headless(arquivo_entrada: Path) -> None:
    """
    ...
    _executar(arquivo_entrada, headless=True)


# ─────────────────────────────────────────────
# MODO 2 — VISUAL (com janela do browser)
# ─────────────────────────────────────────────
def executar_visual(arquivo_entrada: Path) -> None:
    """
    ...
    _executar(arquivo_entrada, headless=False)


# ─────────────────────────────────────────────
# ORQUESTRADOR INTERNO (compartilhado)
# ─────────────────────────────────────────────
def _executar(arquivo_entrada: Path, headless: bool) -> None:
    """
...
def main() -> None:
    ...
    if args.show:
        executar_visual(args.arquivo)
    else:
        executar_headless(args.arquivo)
